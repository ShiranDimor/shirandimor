    ...
    questions: [
      {
        ...
        options: [
          ...
          { value: 'trading_inconsistent', label: 'כבר סוחרים היום אבל עדיין בלי עקביות' },
          { value: 'trading_improve', label: 'כבר סוחרים, ומחפשים לשפר את הדרך' },
        ],
      },
      {
        id: 'markets',
    ...
    questions: [
      {
        ...
        options: [
          ...
          { value: 'prove_to_myself', label: 'להוכיח לעצמי שיש לי את היכולת' },
          { value: 'future_freedom', label: 'ליצור בעתיד יותר חופש - לי ולמשפחה' },
          { value: 'just_checking', label: 'עדיין לא ברור, פשוט רוצה לבדוק אם זה מתאים' },
        ],
      },
      {
        id: 'self_talk',
        ...
        maxSelect: 2,
        options: [
          { value: 'want_but_not_ready', label: 'רוצה להתחיל אבל יש תחושה שעדיין לא יודעים מספיק' },
          { value: 'tried_didnt_work', label: 'כבר ניסיתי בעבר וזה לא באמת עבד לי' },
          { value: 'know_but_dont_execute', label: 'יש לא מעט ידע, אבל בזמן אמת לא עושה מה שתכננתי' },
          { value: 'afraid_lose_money', label: 'פחד מלהפסיד כסף' },
          { value: 'keep_searching_method', label: 'כל הזמן מחפשים עוד שיטה כי אין ביטחון במה שעושה' },
          { value: 'not_for_me', label: 'לפעמים חושבים שמסחר פשוט לא בשבילי' },
          { value: 'hard_to_believe', label: 'רואה אחרים מצליחים אבל קשה להאמין שזה אפשרי גם בשבילי' },
          { value: 'no_time', label: 'אין מספיק זמן להתעסק עם זה' },
          { value: 'rush_to_succeed', label: 'רוצה כל כך להצליח שלפעמים עושה דברים בלי לעצור לחשוב' },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          ...
          { value: 'not_about_money', label: 'אין פחד מיוחד מהכסף - האתגר במקום אחר' },
        ],
      },
    ],
  },
