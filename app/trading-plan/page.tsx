      ...
      {phase === 'intro' && (
        <>
          ...
          <div className="tp-intro-text">
            ...
            {'\n\n'}
            הכנתי תהליך קצר שיעזור לעשות קצת סדר ולצאת מכאן עם תוכנית עבודה ברורה יותר ל-30 הימים הקרובים. בלי חפירות ובלי עוד 74 אינדיקטורים על הגרף :)
          </div>
      ...
      {phase === 'contact' && (
        <>
          ...
          <div className="tp-step-intro">
            נייד ומייל, כדי שנוכל לשלוח את התוכנית האישית בסוף - ואם יהיה צורך לעצור באמצע, אפשר תמיד לחזור אליה יחד.
          </div>
      ...
      {showNudge && (phase === 'contact' || phase === 'quiz') && (
        ...
        >
          <div style={{ fontSize: '13.5px', color: '#fff', lineHeight: 1.5 }}>
            עוד קצת ותוכנית המסחר האישית שלך נשלחת למייל 😊<br />
            חבל לנטוש באמצע!
          </div>
          <button
            type="button"
